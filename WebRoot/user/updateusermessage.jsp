...
System.out.println("调用updateusermessage.jsp");
System.out.println("request.getAttribute()="+request.getAttribute("user"));
%>
...
<html>
  ...
  <body>
  <center>
<form id="form" name="form" method="post" action="<c:url value='/userservlet'/>"> 
			...
			<td width="960" align="center" bgcolor="#F6F6F6">
				<table width="633" height="88" border="0" cellpadding="0" cellspacing="5">
					<tr>
						...
						<td align="left"><input name="user_id" type="text" id="text" size="25" maxlength="20"  value="${user.user_id}"/></td>
					</tr>
					<tr>
						<td align="left"><span class="error_div">*</span>用户密码：</td>
						<td align="left"><input name="user_password" type="text" id="user_password" size="25" maxlength="20" value="${user.user_password}"/></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td width="960" align="center" bgcolor="#F6F6F6">
				<table width="634" height="196" border="0" cellpadding="0" cellspacing="5">
					<tr>
						...
						<td colspan="2" align="left"><input name="user_name" type="text" id="user_name" size="25" maxlength="15" value="${user.user_name}"/>
													</td>
					</tr>
					<tr>
						<td align="left"><span class="error_div">*</span>性别：</td>
						<td colspan="2" align="left"><input type="radio"
														name="user_sex" value="男"  <c:if test="${user.user_sex eq '男'}  }">checked="checked"</c:if> /> 男 <input
														type="radio" name="user_sex" value="女" <c:if test="${user.user_sex eq '女'}  }">checked="checked"</c:if>/> 女</td>
					</tr>
					<tr>
						<td align="left"><span class="error_div">*</span>院系：</td>
						<td><input name="user_academy" type="text" id="user_academy" size="20"
														maxlength="15" value="${user.user_academy}"/>
					...
					<tr>
						...
						<td colspan="2" align="left"><input name="user_phone"
														...
														onblur="testphone()" value="${user.user_phone}"/>
													</td>
					</tr>
					<tr>
